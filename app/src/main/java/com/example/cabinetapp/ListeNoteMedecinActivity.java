...
public class ListeNoteMedecinActivity extends AppCompatActivity {
    ...
    public void addNote(View view) {
        Intent MainActivity = new Intent(ListeNoteMedecinActivity.this, AjouterNoteActivity.class);
        startActivity(MainActivity);
    }

    public void back(View view) {
        Intent MainActivity = new Intent(ListeNoteMedecinActivity.this, MenuMedecinActivity.class);
        startActivity(MainActivity);
    }
}