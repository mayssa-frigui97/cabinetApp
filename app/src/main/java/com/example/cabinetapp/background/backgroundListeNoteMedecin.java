...
public class backgroundListeNoteMedecin extends AsyncTask<String, Void,String> {
    AlertDialog dialog;
    String result = "";
    Intent intent;
    ...
    public backgroundListeNoteMedecin(Context context) {
    ...
    protected String doInBackground(String... voids) {
        ...
        String connstr = "http://169.254.96.165:80/ServiceAppAndroid/ListeNotesMedecin.php";
